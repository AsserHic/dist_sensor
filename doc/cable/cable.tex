...
\begin{itemize}
 ...
 \end{itemize}
 \item Speed of electromagnetic waves in a good conductor is frequency dependent: \\
    $v \approx \SI{0.41}{\meter/\second}\sqrt{\frac{f / \SI{1}{\hertz}}{\sigma_r\mu_r}}$, where
    \begin{description}
      \setbeamertemplate{description item}[align left]
      \item[$\mu_r$] relative magnetic permeability
      \item[$\sigma_r$] conductivity of the material relative to that of copper
    \end{description}
