...
\includegraphics[keepaspectratio, width=0.94\paperwidth]{wires.jpg}
\end{frame}
...
\begin{columns}
 ...
 \begin{column}{0.48\textwidth}
  \tcbox[colframe=green!30!black, colback=green!30]{
    \only<1>{\includegraphics[width=0.65\linewidth]{powerline_h.jpg}}
    \only<5>{\includegraphics[width=0.65\linewidth]{inductors.jpg}}
  }
 ...
 \begin{itemize}
  ...
  \item Length ($\SI{}{\meter}$)
   \begin{itemize}
    ...
    \item Price
   \end{itemize}
  \item Cross-sectional area ($\SI{}{\meter^2}$)
 \end{itemize}
\end{frame}
...
\begin{circuitikz}
  \draw (0,0)
  to[short] (0,2)
  to[short, l_=${l_{left} = 1s\times c}$] (3,2)
  to[voltmeter] (6,2)
  to[short, l_=${l_{right} = 1s\times c}$] (10,2)
  to[short] (10,0)
  to[push button] (3,0)
